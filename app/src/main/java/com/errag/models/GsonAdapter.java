...
public class GsonAdapter<T> implements JsonSerializer<T>, JsonDeserializer<T> {
    ...
    public final JsonElement serialize(final T object, final Type interfaceType, final JsonSerializationContext context) {
        ...
        member.addProperty("jsonType", object.getClass().getName());
        member.add("jsonData", context.serialize(object));
    ...
    public final T deserialize(final JsonElement elem, final Type interfaceType, final JsonDeserializationContext context) throws JsonParseException {
        ...
        final JsonElement typeString = get(member, "jsonType");
        final JsonElement data = get(member, "jsonData");
